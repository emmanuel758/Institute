...
@Component({
  selector: 'app-evaluatio-dialog',
  templateUrl: './evaluatio-dialog.component.html',
  styleUrls: ['./evaluatio-dialog.component.css']
})
export class EvaluatioDialogComponent {
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _dialogRef: MatDialogRef<EvaluatioDialogComponent>,
